...
void wcopcon(UWO data, uint32_t address)
{
...
void wcop1lch(UWO data, uint32_t address)
{
...
void wcop1lcl(UWO data, uint32_t address)
{
...
void wcop2lch(UWO data, uint32_t address)
{
...
void wcop2lcl(UWO data, uint32_t address)
{
...
void wcopjmp1(UWO data, uint32_t address)
{
  copper->Load(copper_registers.cop1lc);
}

UWO rcopjmp1(uint32_t address)
{
  copper->Load(copper_registers.cop1lc);
  return 0;
}
...
void wcopjmp2(UWO data, uint32_t address)
{
  copper->Load(copper_registers.cop2lc);
}

UWO rcopjmp2(uint32_t address)
{
  copper->Load(copper_registers.cop2lc);
  return 0;
}
