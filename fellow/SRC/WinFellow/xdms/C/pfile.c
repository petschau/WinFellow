...
USHORT Process_File(char *iname, char *oname, USHORT cmd, USHORT opt, USHORT PCRC, USHORT pwd)
{
  ...
  if ((cmd == CMD_VIEW) || (cmd == CMD_VIEWFULL))
  {
    ...
    switch (disktype)
    {
      ...
      case 1:
        ...
        break;
      case 2: printf("AmigaOS 2.0 FFS\n"); break;
      case 3: printf("AmigaOS 3.0 OFS / International\n"); break;
      case 4: printf("AmigaOS 3.0 FFS / International\n"); break;
      case 5: printf("AmigaOS 3.0 OFS / Dir Cache\n"); break;
      case 6: printf("AmigaOS 3.0 FFS / Dir Cache\n"); break;
      case 7: printf("FMS Amiga System File\n"); break;
  ...
  if (((cmd == CMD_UNPACK) || (cmd == CMD_SHOWBANNER)) && (geninfo & 2) && (!pwd)) return ERR_NOPASSWD;
