...
extern STR *iniGetConfigurationHistoryFilename(ini *initdata, uint32_t position);
extern void iniSetConfigurationHistoryFilename(ini *initdata, uint32_t position, STR *configuration);
extern STR *iniGetConfigurationHistoryFilename(ini *initdata, uint32_t position);
extern void iniSetConfigurationHistoryFilename(ini *initdata, uint32_t position, STR *cfgfilename);
