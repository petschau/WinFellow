...
{
	uint32_t src = (uint32_t)(LON)(WOR)cpuGetDRegWord(opc_data[0]);
...
{
	uint32_t src = (uint32_t)(LON)(WOR)cpuGetARegWord(opc_data[0]);
	uint32_t dst = cpuGetAReg(opc_data[1]);
	dst = cpuAddaL(dst, src);
	cpuSetAReg(opc_data[1], dst);
	cpuSetInstructionTime(8);
...
{
	uint32_t src = (uint32_t)(LON)(WOR)memoryReadWord(cpuEA02(opc_data[0]));
	uint32_t dst = cpuGetAReg(opc_data[1]);
	dst = cpuAddaL(dst, src);
	cpuSetAReg(opc_data[1], dst);
	cpuSetInstructionTime(12);
...
{
	uint32_t src = (uint32_t)(LON)(WOR)memoryReadWord(cpuEA03(opc_data[0],2));
	uint32_t dst = cpuGetAReg(opc_data[1]);
	dst = cpuAddaL(dst, src);
	cpuSetAReg(opc_data[1], dst);
	cpuSetInstructionTime(12);
...
{
	uint32_t src = (uint32_t)(LON)(WOR)memoryReadWord(cpuEA04(opc_data[0],2));
	uint32_t dst = cpuGetAReg(opc_data[1]);
	dst = cpuAddaL(dst, src);
	cpuSetAReg(opc_data[1], dst);
	cpuSetInstructionTime(14);
...
{
	uint32_t src = (uint32_t)(LON)(WOR)memoryReadWord(cpuEA05(opc_data[0]));
	uint32_t dst = cpuGetAReg(opc_data[1]);
	dst = cpuAddaL(dst, src);
	cpuSetAReg(opc_data[1], dst);
	cpuSetInstructionTime(16);
...
{
	uint32_t src = (uint32_t)(LON)(WOR)memoryReadWord(cpuEA06(opc_data[0]));
	uint32_t dst = cpuGetAReg(opc_data[1]);
	dst = cpuAddaL(dst, src);
	cpuSetAReg(opc_data[1], dst);
	cpuSetInstructionTime(18);
...
{
	uint32_t src = (uint32_t)(LON)(WOR)memoryReadWord(cpuEA70());
	uint32_t dst = cpuGetAReg(opc_data[1]);
	dst = cpuAddaL(dst, src);
	cpuSetAReg(opc_data[1], dst);
	cpuSetInstructionTime(16);
...
{
	uint32_t src = (uint32_t)(LON)(WOR)memoryReadWord(cpuEA71());
	uint32_t dst = cpuGetAReg(opc_data[1]);
	dst = cpuAddaL(dst, src);
	cpuSetAReg(opc_data[1], dst);
	cpuSetInstructionTime(20);
...
{
	uint32_t src = (uint32_t)(LON)(WOR)memoryReadWord(cpuEA72());
	uint32_t dst = cpuGetAReg(opc_data[1]);
	dst = cpuAddaL(dst, src);
	cpuSetAReg(opc_data[1], dst);
	cpuSetInstructionTime(16);
...
{
	uint32_t src = (uint32_t)(LON)(WOR)memoryReadWord(cpuEA73());
	uint32_t dst = cpuGetAReg(opc_data[1]);
	dst = cpuAddaL(dst, src);
	cpuSetAReg(opc_data[1], dst);
	cpuSetInstructionTime(18);
...
{
	uint32_t src = (uint32_t)(LON)(WOR)cpuGetNextWord();
	uint32_t dst = cpuGetAReg(opc_data[1]);
	dst = cpuAddaL(dst, src);
	cpuSetAReg(opc_data[1], dst);
	cpuSetInstructionTime(12);
...
{
	UWO src = cpuGetDRegWord(opc_data[0]);
	cpuSetAReg(opc_data[1], (uint32_t)(LON)(WOR)src);
	cpuSetInstructionTime(4);
}
