...
extern void ccwStaticSetText(HWND windowHandle, int controlIdentifier, const char* text);
extern void ccwEditSetText(HWND windowHandle, int controlIdentifier, const char* text);
