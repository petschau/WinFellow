...
!define INSTALLER_NAME "WinFellow_v${FELLOWVERSION}_x64.exe"
...
InstallDir "$PROGRAMFILES64\WinFellow"
...
Function .onInit
  ${IfNot} ${RunningX64}
    MessageBox MB_ICONSTOP "You seem to be using a 32 bit system; this installer is intended for 64 bit systems only, aborting."
    SetErrorLevel -1
    Abort
  ${EndIf}
FunctionEnd
...
File /oname=WinFellow.exe "$%TEMP%\WinFellow_v${FELLOWVERSION}\WinFellow_x64.exe"
File /oname=WinFellow.pdb "$%TEMP%\WinFellow_v${FELLOWVERSION}\WinFellow_x64.pdb"
