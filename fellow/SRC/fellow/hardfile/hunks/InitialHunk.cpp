...
namespace fellow::hardfile::hunks
{
  ...
  InitialHunk::InitialHunk(ULO allocateSizeInLongwords) : _allocateSizeInLongwords(allocateSizeInLongwords), _contentSizeInLongwords(0), _vmAddress(0), _rawData(nullptr)
  {
  }
}
