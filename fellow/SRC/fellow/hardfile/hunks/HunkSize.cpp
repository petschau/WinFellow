...
namespace fellow::hardfile::hunks
{
  ...
  HunkSize::HunkSize(ULO sizeInLongwords, ULO memoryFlags, ULO additionalFlags) : SizeInLongwords(sizeInLongwords), MemoryFlags(memoryFlags), AdditionalFlags(additionalFlags)
  {
  }
}
