...
{
  RectShresi MaxClip; // Shresi coordinate extent of the chipset buffer, ie. the screen area that the emulator is generating an internal image for. Set
                      // during startup to ChipsetMaxClipPal, RP sets different values.
