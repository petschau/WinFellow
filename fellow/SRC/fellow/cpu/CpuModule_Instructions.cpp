...
/// </summary>
/// <returns>The result</returns>
constexpr ULO cpuAddaW(ULO src2, ULO src1)
{
  return src2 + src1;
}
...
/// </summary>
/// <returns>The result</returns>
constexpr ULO cpuAddaL(ULO src2, ULO src1)
{
  return src2 + src1;
}
...
/// </summary>
/// <returns>The result</returns>
constexpr ULO cpuSubaW(ULO src2, ULO src1)
{
  return src2 - src1;
}
...
/// </summary>
/// <returns>The result</returns>
constexpr ULO cpuSubaL(ULO src2, ULO src1)
{
  return src2 - src1;
}
...
static void cpuMulL(ULO src1, UWO extension)
{
  ...
  if (extension & 0x0800) // muls.l
  {
    ...
    {
      BOOLE o = (result >= 0) ? ((result & 0xffffffff00000000) != 0) : ((result & 0xffffffff00000000) != 0xffffffff00000000);
      cpuSetDReg(dl, (ULO)result);
...
static void cpuDivL(ULO divisor, ULO ext, ULO instruction_time)
{
  if (divisor != 0)
  {
    ...
    if (sign)
    {
      LLO x_signed;
      if (size64)
        x_signed = (LLO)((ULL)cpuGetDReg(dq_reg)) | (((LLO)cpuGetDReg(dr_reg)) << 32);
      else
        x_signed = (LLO)(LON)cpuGetDReg(dq_reg);
      LLO y_signed = (LLO)(LON)divisor;
    ...
    {
      if (size64)
        x = ((ULL)cpuGetDReg(dq_reg)) | (((ULL)cpuGetDReg(dr_reg)) << 32);
      else
        x = (ULL)cpuGetDReg(dq_reg);
      y = (ULL)divisor;
    }
