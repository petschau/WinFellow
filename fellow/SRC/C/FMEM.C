/* @(#) $Id: FMEM.C,v 1.7 2008-02-20 23:56:29 peschau Exp $ */
/*=========================================================================*/
/* Fellow                                                                  */
...
{
  memory_noiseounter++;
  return (UWO) memory_noise[memory_noiseounter & 0x1];
}
...
static void memoryOddRead(ULO address)
{
  if ((address & 0x1) == 0x1)
  {
    if (cpu_major < 2)
    {
      ...
      cpuPrepareException(0x0c, cpuGetPC(), TRUE);
    }
  }
}
