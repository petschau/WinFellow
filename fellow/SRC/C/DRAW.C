...
static __inline void drawLineNormal1xX__8bit(graph_line *linedescription, ULO nextlineoffset, ULO verticalscale)
{
  ...
  else
  {
    ...
    while (pixels_left_to_draw-- > 0)
    {
      color = colors[*source_ptr++];
      *framebuffer = color;
      *(framebuffer + nextlineoffset * 4) = color;
      framebuffer++;
    }
  }
...
static __inline void drawLineNormal1xX_24bit(graph_line *linedescription, ULO nextlineoffset, ULO verticalscale)
{
  ...
  if (pixels_left_to_draw > 2)
  {
	...
	*((ULO *) draw_buffer_current_ptr) = *((ULO *) draw_buffer_current_ptr + nextlineoffset) = decoded_color;
	...
	{
		// synchronize with 32 bit address
		while (PTR_TO_INT(draw_buffer_current_ptr) & 3)
		{
			decoded_color = *((ULO *) ((UBY *) linedescription->colors + *source_ptr));
			if (verticalscale == 1)
			{
...
static __inline void drawLineNormal2xX_24bit(graph_line *linedescription, ULO nextlineoffset, ULO verticalscale)
{
  ...
  if (pixels_left_to_draw > 2)
  {
	...
	*((ULO *) draw_buffer_current_ptr) = *((ULO *) draw_buffer_current_ptr + nextlineoffset) = decoded_color_d;
	...
	if (verticalscale == 1)
	{
		if ((PTR_TO_INT(draw_buffer_current_ptr) & 3) == 2)
		{
			// with two 24 bit writes, this case reverts to the 0x01 case (with already one pixel fully scaled)
			decoded_color = *((ULO *) ((UBY *) linedescription->colors + *source_ptr));
			if (verticalscale == 1)
		...
		if ((PTR_TO_INT(draw_buffer_current_ptr) & 3) == 1)
		{
			// we can align it after one 24 bit write, but this leaves us one pixel not fully scaled
			decoded_color_d = *((ULO *) ((UBY *) linedescription->colors + *source_ptr));
			if (verticalscale == 1)
...
static void drawSetPixel1x2_32Bit(ULO *framebuffer, ULO nextlineoffset, ULO pixel_color)
{
  framebuffer[0] = pixel_color;
  framebuffer[nextlineoffset] = pixel_color;
}

static void drawSetPixel2x2_32Bit(ULO *framebuffer, ULO nextlineoffset, ULO pixel_color)
{
  framebuffer[0] = pixel_color;
  framebuffer[1] = pixel_color;
  framebuffer[nextlineoffset] = pixel_color;
  framebuffer[nextlineoffset + 1] = pixel_color;
}
...
static __inline void drawLineDual1x1_16bit_faster(graph_line *linedescription, ULO nextlineoffset)
{
  ...
  if (PTR_TO_INT(draw_buffer_current_ptr) & 2)
  {
...
void drawLineDual1x1_32bit(graph_line *linedescription, ULO nextlineoffset)
{
  ...
  while (pixels_left_to_draw-- > 0)
  {
    pixel_color = *((ULO *) ((UBY *) linedescription->colors + (*(draw_dual_translate_ptr + ((*source_line1_ptr++ << 8) + *source_line2_ptr++)))));
    *framebuffer++ = pixel_color;
  }
  draw_buffer_current_ptr = (UBY*) framebuffer;
...
static __inline void drawLineSegmentBG1x1__8bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  UBY *framebuffer = draw_buffer_current_ptr;
  ULO i;
...
static __inline void drawLineSegmentBG1x2__8bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  UBY *framebuffer = draw_buffer_current_ptr;
  ULO i;
  ...
  if (pixelcount >= 4)
  {
    ...
    {
      *framebuffer = (UBY) bgcolor;
      *(framebuffer + nextlineoffset*4)= (UBY) bgcolor;
      framebuffer++;
      pixelcount--;
    }
    ...
    {
      *((UWO *) framebuffer) = (UWO) bgcolor;
      *((UWO *) framebuffer + nextlineoffset*2) = (UWO) bgcolor;
      pixelcount -= 2;
      framebuffer += 2;
    }
...
static __inline void drawLineSegmentBG2x1__8bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  UWO *framebuffer = (UWO*) draw_buffer_current_ptr;
  ULO i;
...
static __inline void drawLineSegmentBG2x2__8bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  UWO *framebuffer = (UWO*) draw_buffer_current_ptr;
  ULO i;
  ...
  if (pixelcount >= 2)
  {
    ...
    {
      *framebuffer = (UWO) bgcolor;
      *(framebuffer + nextlineoffset*2) = (UWO) bgcolor;
      pixelcount--;
      framebuffer++;
    }
...
static __inline void drawLineSegmentBG1x1_16bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  UWO *framebuffer = (UWO *) draw_buffer_current_ptr;
  ULO *fb_l;
  ULO i;
  ...
  if (pixelcount & 1) *framebuffer++ = (UWO) bgcolor;
  draw_buffer_current_ptr = (UBY*) framebuffer;
}
...
static __inline void drawLineSegmentBG1x2_16bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  UWO *framebuffer = (UWO *) draw_buffer_current_ptr;
  ULO *fb_l;
  ULO i;
  ...
  {
    *framebuffer = (UWO) bgcolor;
    *(framebuffer + nextlineoffset_local) = (UWO) bgcolor;
    framebuffer++;
    pixelcount--;
  }
  /* Set two pixels at a time */
...
static __inline void drawLineSegmentBG2x1_16bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  ULO *framebuffer = (ULO *) draw_buffer_current_ptr;
  ULO i;
  for (i = 0; i < pixelcount; i++) framebuffer[i] = bgcolor;
  draw_buffer_current_ptr = (UBY*) (framebuffer + pixelcount);
}
...
static __inline void drawLineSegmentBG2x2_16bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  ULO *framebuffer = (ULO *) draw_buffer_current_ptr;
  ULO i;
  for (i = 0; i < pixelcount; i++)
  {
    ...
    framebuffer[i + nextlineoffset] = bgcolor;
  }
  draw_buffer_current_ptr = (UBY*) (framebuffer + pixelcount);
}
...
static __inline void drawLineSegmentBG2xX_24bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset, ULO verticalscale)
{
  ...
  ULO bgcolor_c = (bgcolor_b >> 8) | ((bgcolor >> 16) << 24);  // [2;1;0;2]
	...
	if (pixelcount >= 2)
	{
		while (PTR_TO_INT(draw_buffer_current_ptr) & 2)
		{
			if (verticalscale == 1)
			{
				*((ULO *) draw_buffer_current_ptr) = bgcolor;
...
static __inline void drawLineSegmentBG1x1_24bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  drawLineSegmentBG1xX_24bit(pixelcount, bgcolor, nextlineoffset, 1);
}

static __inline void drawLineSegmentBG1x2_24bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  drawLineSegmentBG1xX_24bit(pixelcount, bgcolor, nextlineoffset, 2);
}

static __inline void drawLineSegmentBG2x1_24bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  drawLineSegmentBG2xX_24bit(pixelcount, bgcolor, nextlineoffset, 1);
}

static __inline void drawLineSegmentBG2x2_24bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  drawLineSegmentBG2xX_24bit(pixelcount, bgcolor, nextlineoffset, 2);
}
...
static __inline void drawLineSegmentBG1x1_32bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  ULO *framebuffer = (ULO *) draw_buffer_current_ptr;
  ULO i;
...
static __inline void drawLineSegmentBG1x2_32bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  ULO *framebuffer = (ULO *) draw_buffer_current_ptr;
  ULO i;
...
static __inline void drawLineSegmentBG2x1_32bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  ULO *framebuffer = (ULO *) draw_buffer_current_ptr;
  ULO i;
  ULO count = pixelcount*2;
...
static __inline void drawLineSegmentBG2x2_32bit(ULO pixelcount, ULO bgcolor, ULO nextlineoffset)
{
  ULO *framebuffer = (ULO *) draw_buffer_current_ptr;
  ULO i;
  ULO count = pixelcount*2;
...
static __inline void drawLineHAM1xX__8bit(graph_line *linedesc, ULO nextlineoffset, ULO verticalscale)
{
	...
	if (nonvisible > 0)
	{
		...
		while (nonvisible > 0) 
		{
			...
			{
				holdmask = ((UBY *) draw_HAM_modify_table + ((*source_line_ptr & 0xc0) >> 3));
