...
namespace test::fellow::hardfile::rdb
{
  TEST_CLASS(RDBTest)
  {
    ...
    const STR* BlankWithRDB_SFS = R"(testdata\hardfile\rdb\BlankWithRDB_SFS.hdf)";
    const STR* BlankWithRDB_PFS = R"(testdata\hardfile\rdb\BlankWithRDB_PFS.hdf)";
    const STR* BlankWithRDB_FFS13 = R"(testdata\hardfile\rdb\BlankWithRDB_FFS13.hdf)";
    const STR* BlankWithRDB_FFS31 = R"(testdata\hardfile\rdb\BlankWithRDB_FFS31.hdf)";
    const STR* BlankWithoutRDB_OFS = R"(testdata\hardfile\rdb\BlankWithoutRDB_OFS.hdf)";
    const STR* ManyPartitionsWithRDB_ManyFS = R"(testdata\hardfile\rdb\ManyPartitionsWithRDB_ManyFS.hdf)";
    const STR* RDBInvalidCheckSum = R"(testdata\hardfile\rdb\WithRDSKMarkerInvalidChecksum.hdf)";
    const STR* RDBPartitionInvalidCheckSum = R"(testdata\hardfile\rdb\WithRDBInvalidPartitionCheckSum.hdf)";
    const STR* RDBFileSystemHeaderInvalidCheckSum = R"(testdata\hardfile\rdb\WithRDBInvalidFileSystemHeaderCheckSum.hdf)";
    const STR* RDBLSegBlockInvalidCheckSum = R"(testdata\hardfile\rdb\WithRDBInvalidLSegBlockCheckSum.hdf)";
