...
{
  _playfield_odd.blu[_batch_size].l = P2COdd1(dat1, dat3, dat5); 
  _playfield_odd.blu[_batch_size].l |= P2CEven1(dat2, dat4, dat6);
  _batch_size++;
}

void Planar2ChunkyDecoder::P2CNext4PixelsDual(ULO dat1, ULO dat2, ULO dat3, ULO dat4, ULO dat5, ULO dat6)
{
  _playfield_odd.blu[_batch_size].l = P2CDual1(dat1, dat3, dat5); 
  _playfield_even.blu[_batch_size].l = P2CDual1(dat2, dat4, dat6); 
  _batch_size++;
}
...
void Planar2ChunkyDecoder::P2CNext8PixelsNormal(ULO dat1, ULO dat2, ULO dat3, ULO dat4, ULO dat5, ULO dat6)
{
  ...
  _playfield_odd.blu[_batch_size].l |= P2CEven1(dat2, dat4, dat6);
  _batch_size++;
  _playfield_odd.blu[_batch_size].l = P2COdd2(dat1, dat3, dat5); 
  _playfield_odd.blu[_batch_size].l |= P2CEven2(dat2, dat4, dat6);
  _batch_size++;
}
...
void Planar2ChunkyDecoder::P2CNext8PixelsDual(ULO dat1, ULO dat2, ULO dat3, ULO dat4, ULO dat5, ULO dat6)
{
  ...
  _playfield_even.blu[_batch_size].l = P2CDual1(dat2, dat4, dat6); 
  _batch_size++;
  _playfield_odd.blu[_batch_size].l = P2CDual2(dat1, dat3, dat5); 
  _playfield_even.blu[_batch_size].l = P2CDual2(dat2, dat4, dat6); 
  _batch_size++;
}
